...
class EffAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = qkv[0], qkv[1], qkv[2]  #B, 8, N, C//8
...
class MODEL(nn.Module):
    ...
    def forward(self, x):
        ...
        out_2 = self.MY2(out_1 + self.conv_up(out2_trans)) # self.MY2() share parameters with out1
        out_3 = self.MY3(out_2) # self.MY3() share parameters with out1
