...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='/data2/wenjieli/datasets/SISR_datasets',
...
# args.scale = [args.scale,args.scale,args.scale]#[pow(2, s+1) for s in range(int(np.log2(args.scale)))]
